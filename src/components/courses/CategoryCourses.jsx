...
//         setCategoryName(res.data.category?.name || categorySlug);
//       } catch (err) {
...
//       <h1 className="text-3xl font-bold mb-6">Courses in {categoryName}</h1>
...
//           {courses.map((course) => (
//             <div key={course.slug} className="border rounded-lg shadow p-4">
...
//       {courses.length === 0 ? (
//         <p className="text-center text-gray-600">No courses found in this category.</p>
//       ) : (
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
//           {courses.map((course) => (
//             <div key={course.slug} className="bg-white shadow rounded-lg overflow-hidden flex flex-col">
//               <img
//                 src={course.image}
//                 alt={course.name}
...
//                 <h2 className="text-xl font-bold mb-2">{course.name}</h2>
//                 <p className="text-gray-600 mb-2">{course.meta_description}</p>
...
//                   <Link
//                     to={`/courses/${categorySlug}/${course.slug}`}
//                     className="block bg-purple-700 text-white text-center py-2 rounded-md hover:bg-purple-800 transition"
//                   >
//                     View Course Details
//                   </Link>
//                 </div>
